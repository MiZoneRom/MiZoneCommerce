 ...
 */
!function(n,t){"object"==typeof exports&&"undefined"!=typeof module?t(exports,require("jquery")):"function"==typeof define&&define.amd?define(["exports","jquery"],t):t((n="undefined"!=typeof globalThis?globalThis:n||self).adminlte={},n.jQuery)}(this,function(n,t){"use strict";function pt(n){return n&&"object"==typeof n&&"default"in n?n:{"default":n}}var i=pt(t),l="CardRefresh",wt=i.default.fn[l],ht={source:"",sourceSelector:"",params:{},trigger:'[data-card-widget="card-refresh"]',content:".card-body",loadInContent:!0,loadOnInit:!0,responseType:"",overlayTemplate:'<div class="overlay"><i class="fas fa-2x fa-sync-alt fa-spin"><\/i><\/div>',onLoadStart:function(){},onLoadDone:function(n){return n}},e=function(){function n(n,t){if(this._element=n,this._parent=n.parents(".card").first(),this._settings=i.default.extend({},ht,t),this._overlay=i.default(this._settings.overlayTemplate),n.hasClass("card")&&(this._parent=n),""===this._settings.source)throw new Error("Source url was not defined. Please specify a url in your CardRefresh source option.");}var t=n.prototype;return t.load=function(){var n=this;this._addOverlay();this._settings.onLoadStart.call(i.default(this));i.default.get(this._settings.source,this._settings.params,function(t){n._settings.loadInContent&&(""!==n._settings.sourceSelector&&(t=i.default(t).find(n._settings.sourceSelector).html()),n._parent.find(n._settings.content).html(t));n._settings.onLoadDone.call(i.default(n),t);n._removeOverlay()},""!==this._settings.responseType&&this._settings.responseType);i.default(this._element).trigger(i.default.Event("loaded.lte.cardrefresh"))},t._addOverlay=function(){this._parent.append(this._overlay);i.default(this._element).trigger(i.default.Event("overlay.added.lte.cardrefresh"))},t._removeOverlay=function(){this._parent.find(this._overlay).remove();i.default(this._element).trigger(i.default.Event("overlay.removed.lte.cardrefresh"))},t._init=function(){var n=this;i.default(this).find(this._settings.trigger).on("click",function(){n.load()});this._settings.loadOnInit&&this.load()},n._jQueryInterface=function(t){var r=i.default(this).data("lte.cardrefresh"),u=i.default.extend({},ht,i.default(this).data());r||(r=new n(i.default(this),u),i.default(this).data("lte.cardrefresh","string"==typeof t?r:t));"string"==typeof t&&t.match(/load/)?r[t]():r._init(i.default(this))},n}();i.default(document).on("click",'[data-card-widget="card-refresh"]',function(n){n&&n.preventDefault();e._jQueryInterface.call(i.default(this),"load")});i.default(function(){i.default('[data-card-widget="card-refresh"]').each(function(){e._jQueryInterface.call(i.default(this))})});i.default.fn[l]=e._jQueryInterface;i.default.fn[l].Constructor=e;i.default.fn[l].noConflict=function(){return i.default.fn[l]=wt,e._jQueryInterface};var a="CardWidget",bt=i.default.fn[a],ct={animationSpeed:"normal",collapseTrigger:'[data-card-widget="collapse"]',removeTrigger:'[data-card-widget="remove"]',maximizeTrigger:'[data-card-widget="maximize"]',collapseIcon:"fa-minus",expandIcon:"fa-plus",maximizeIcon:"fa-expand",minimizeIcon:"fa-compress"},u=function(){function t(n,t){this._element=n;this._parent=n.parents(".card").first();n.hasClass("card")&&(this._parent=n);this._settings=i.default.extend({},ct,t)}var n=t.prototype;return n.collapse=function(){var n=this;this._parent.addClass("collapsing-card").children(".card-body, .card-footer").slideUp(this._settings.animationSpeed,function(){n._parent.addClass("collapsed-card").removeClass("collapsing-card")});this._parent.find("> .card-header "+this._settings.collapseTrigger+" ."+this._settings.collapseIcon).addClass(this._settings.expandIcon).removeClass(this._settings.collapseIcon);this._element.trigger(i.default.Event("collapsed.lte.cardwidget"),this._parent)},n.expand=function(){var n=this;this._parent.addClass("expanding-card").children(".card-body, .card-footer").slideDown(this._settings.animationSpeed,function(){n._parent.removeClass("collapsed-card").removeClass("expanding-card")});this._parent.find("> .card-header "+this._settings.collapseTrigger+" ."+this._settings.expandIcon).addClass(this._settings.collapseIcon).removeClass(this._settings.expandIcon);this._element.trigger(i.default.Event("expanded.lte.cardwidget"),this._parent)},n.remove=function(){this._parent.slideUp();this._element.trigger(i.default.Event("removed.lte.cardwidget"),this._parent)},n.toggle=function(){this._parent.hasClass("collapsed-card")?this.expand():this.collapse()},n.maximize=function(){this._parent.find(this._settings.maximizeTrigger+" ."+this._settings.maximizeIcon).addClass(this._settings.minimizeIcon).removeClass(this._settings.maximizeIcon);this._parent.css({height:this._parent.height(),width:this._parent.width(),transition:"all .15s"}).delay(150).queue(function(){var n=i.default(this);n.addClass("maximized-card");i.default("html").addClass("maximized-card");n.hasClass("collapsed-card")&&n.addClass("was-collapsed");n.dequeue()});this._element.trigger(i.default.Event("maximized.lte.cardwidget"),this._parent)},n.minimize=function(){this._parent.find(this._settings.maximizeTrigger+" ."+this._settings.minimizeIcon).addClass(this._settings.maximizeIcon).removeClass(this._settings.minimizeIcon);this._parent.css("cssText","height: "+this._parent[0].style.height+" !important; width: "+this._parent[0].style.width+" !important; transition: all .15s;").delay(10).queue(function(){var n=i.default(this);n.removeClass("maximized-card");i.default("html").removeClass("maximized-card");n.css({height:"inherit",width:"inherit"});n.hasClass("was-collapsed")&&n.removeClass("was-collapsed");n.dequeue()});this._element.trigger(i.default.Event("minimized.lte.cardwidget"),this._parent)},n.toggleMaximize=function(){this._parent.hasClass("maximized-card")?this.minimize():this.maximize()},n._init=function(n){var t=this;this._parent=n;i.default(this).find(this._settings.collapseTrigger).click(function(){t.toggle()});i.default(this).find(this._settings.maximizeTrigger).click(function(){t.toggleMaximize()});i.default(this).find(this._settings.removeTrigger).click(function(){t.remove()})},t._jQueryInterface=function(n){var r=i.default(this).data("lte.cardwidget"),u=i.default.extend({},ct,i.default(this).data());r||(r=new t(i.default(this),u),i.default(this).data("lte.cardwidget","string"==typeof n?r:n));"string"==typeof n&&n.match(/collapse|expand|remove|toggle|maximize|minimize|toggleMaximize/)?r[n]():"object"==typeof n&&r._init(i.default(this))},t}();i.default(document).on("click",'[data-card-widget="collapse"]',function(n){n&&n.preventDefault();u._jQueryInterface.call(i.default(this),"toggle")});i.default(document).on("click",'[data-card-widget="remove"]',function(n){n&&n.preventDefault();u._jQueryInterface.call(i.default(this),"remove")});i.default(document).on("click",'[data-card-widget="maximize"]',function(n){n&&n.preventDefault();u._jQueryInterface.call(i.default(this),"toggleMaximize")});i.default.fn[a]=u._jQueryInterface;i.default.fn[a].Constructor=u;i.default.fn[a].noConflict=function(){return i.default.fn[a]=bt,u._jQueryInterface};var v="ControlSidebar",kt=i.default.fn[v],dt={controlsidebarSlide:!0,scrollbarTheme:"os-theme-light",scrollbarAutoHide:"l"},y=function(){function t(n,t){this._element=n;this._config=t;this._init()}var n=t.prototype;return n.collapse=function(){var n=i.default("body"),t=i.default("html");this._config.controlsidebarSlide?(t.addClass("control-sidebar-animate"),n.removeClass("control-sidebar-slide-open").delay(300).queue(function(){i.default(".control-sidebar").hide();t.removeClass("control-sidebar-animate");i.default(this).dequeue()})):n.removeClass("control-sidebar-open");i.default(this._element).trigger(i.default.Event("collapsed.lte.controlsidebar"))},n.show=function(){var n=i.default("body"),t=i.default("html");this._config.controlsidebarSlide?(t.addClass("control-sidebar-animate"),i.default(".control-sidebar").show().delay(10).queue(function(){n.addClass("control-sidebar-slide-open").delay(300).queue(function(){t.removeClass("control-sidebar-animate");i.default(this).dequeue()});i.default(this).dequeue()})):n.addClass("control-sidebar-open");this._fixHeight();this._fixScrollHeight();i.default(this._element).trigger(i.default.Event("expanded.lte.controlsidebar"))},n.toggle=function(){var n=i.default("body");n.hasClass("control-sidebar-open")||n.hasClass("control-sidebar-slide-open")?this.collapse():this.show()},n._init=function(){var n=this;this._fixHeight();this._fixScrollHeight();i.default(window).resize(function(){n._fixHeight();n._fixScrollHeight()});i.default(window).scroll(function(){var t=i.default("body");(t.hasClass("control-sidebar-open")||t.hasClass("control-sidebar-slide-open"))&&n._fixScrollHeight()})},n._fixScrollHeight=function(){var t=i.default("body"),o;if(t.hasClass("layout-fixed")){var n={scroll:i.default(document).height(),window:i.default(window).height(),header:i.default(".main-header").outerHeight(),footer:i.default(".main-footer").outerHeight()},f=Math.abs(n.window+i.default(window).scrollTop()-n.scroll),u=i.default(window).scrollTop(),s=(t.hasClass("layout-navbar-fixed")||t.hasClass("layout-sm-navbar-fixed")||t.hasClass("layout-md-navbar-fixed")||t.hasClass("layout-lg-navbar-fixed")||t.hasClass("layout-xl-navbar-fixed"))&&"fixed"===i.default(".main-header").css("position"),h=(t.hasClass("layout-footer-fixed")||t.hasClass("layout-sm-footer-fixed")||t.hasClass("layout-md-footer-fixed")||t.hasClass("layout-lg-footer-fixed")||t.hasClass("layout-xl-footer-fixed"))&&"fixed"===i.default(".main-footer").css("position"),r=i.default(".control-sidebar"),e=i.default(".control-sidebar, .control-sidebar .control-sidebar-content");0===u&&0===f?(r.css({bottom:n.footer,top:n.header}),e.css("height",n.window-(n.header+n.footer))):f<=n.footer?!1===h?(o=n.header-u,r.css("bottom",n.footer-f).css("top",o>=0?o:0),e.css("height",n.window-(n.footer-f))):r.css("bottom",n.footer):u<=n.header?!1===s?(r.css("top",n.header-u),e.css("height",n.window-(n.header-u))):r.css("top",n.header):!1===s?(r.css("top",0),e.css("height",n.window)):r.css("top",n.header)}},n._fixHeight=function(){var n=i.default("body"),t;if(n.hasClass("layout-fixed")){var r=i.default(window).height(),u=i.default(".main-header").outerHeight(),e=i.default(".main-footer").outerHeight(),f=r-u;(n.hasClass("layout-footer-fixed")||n.hasClass("layout-sm-footer-fixed")||n.hasClass("layout-md-footer-fixed")||n.hasClass("layout-lg-footer-fixed")||n.hasClass("layout-xl-footer-fixed"))&&"fixed"===i.default(".main-footer").css("position")&&(f=r-u-e);t=i.default(".control-sidebar .control-sidebar-content");t.css("height",f);"undefined"!=typeof i.default.fn.overlayScrollbars&&t.overlayScrollbars({className:this._config.scrollbarTheme,sizeAutoCapable:!0,scrollbars:{autoHide:this._config.scrollbarAutoHide,clickScrolling:!0}})}},t._jQueryInterface=function(n){return this.each(function(){var r=i.default(this).data("lte.controlsidebar"),u=i.default.extend({},dt,i.default(this).data());if(r||(r=new t(this,u),i.default(this).data("lte.controlsidebar",r)),"undefined"===r[n])throw new Error(n+" is not a function");r[n]()})},t}();i.default(document).on("click",'[data-widget="control-sidebar"]',function(n){n.preventDefault();y._jQueryInterface.call(i.default(this),"toggle")});i.default.fn[v]=y._jQueryInterface;i.default.fn[v].Constructor=y;i.default.fn[v].noConflict=function(){return i.default.fn[v]=kt,y._jQueryInterface};var p="DirectChat",gt=i.default.fn[p],w=function(){function n(n){this._element=n}return n.prototype.toggle=function(){i.default(this._element).parents(".direct-chat").first().toggleClass("direct-chat-contacts-open");i.default(this._element).trigger(i.default.Event("toggled.lte.directchat"))},n._jQueryInterface=function(t){return this.each(function(){var r=i.default(this).data("lte.directchat");r||(r=new n(i.default(this)),i.default(this).data("lte.directchat",r));r[t]()})},n}();i.default(document).on("click",'[data-widget="chat-pane-toggle"]',function(n){n&&n.preventDefault();w._jQueryInterface.call(i.default(this),"toggle")});i.default.fn[p]=w._jQueryInterface;i.default.fn[p].Constructor=w;i.default.fn[p].noConflict=function(){return i.default.fn[p]=gt,w._jQueryInterface};var b="Dropdown",ni=i.default.fn[b],ti={},o=function(){function n(n,t){this._config=t;this._element=n}var t=n.prototype;return t.toggleSubmenu=function(){this._element.siblings().show().toggleClass("show");this._element.next().hasClass("show")||this._element.parents(".dropdown-menu").first().find(".show").removeClass("show").hide();this._element.parents("li.nav-item.dropdown.show").on("hidden.bs.dropdown",function(){i.default(".dropdown-submenu .show").removeClass("show").hide()})},t.fixPosition=function(){var n=i.default(".dropdown-menu.show");if(0!==n.length){n.hasClass("dropdown-menu-right")?n.css({left:"inherit",right:0}):n.css({left:0,right:"inherit"});var t=n.offset(),r=n.width(),u=i.default(window).width()-t.left;t.left<0?n.css({left:"inherit",right:t.left-5}):u<r&&n.css({left:"inherit",right:0})}},n._jQueryInterface=function(t){return this.each(function(){var r=i.default(this).data("lte.dropdown"),u=i.default.extend({},ti,i.default(this).data());r||(r=new n(i.default(this),u),i.default(this).data("lte.dropdown",r));"toggleSubmenu"!==t&&"fixPosition"!==t||r[t]()})},n}();i.default('.dropdown-menu [data-toggle="dropdown"]').on("click",function(n){n.preventDefault();n.stopPropagation();o._jQueryInterface.call(i.default(this),"toggleSubmenu")});i.default('.navbar [data-toggle="dropdown"]').on("click",function(n){n.preventDefault();i.default(n.target).parent().hasClass("dropdown-submenu")||setTimeout(function(){o._jQueryInterface.call(i.default(this),"fixPosition")},1)});i.default.fn[b]=o._jQueryInterface;i.default.fn[b].Constructor=o;i.default.fn[b].noConflict=function(){return i.default.fn[b]=ni,o._jQueryInterface};var k="ExpandableTable",ii=i.default.fn[k],s=function(){function n(n,t){this._options=t;this._element=n}var t=n.prototype;return t.init=function(){i.default('[data-widget="expandable-table"]').each(function(n,t){var u=i.default(t).attr("aria-expanded"),r=i.default(t).next().children().first().children();"true"===u?r.show():"false"===u&&(r.hide(),r.parent().parent().addClass("d-none"))})},t.toggleRow=function(){var n=this._element,r=n.attr("aria-expanded"),t=n.next().children().first().children();t.stop();"true"===r?(t.slideUp(500,function(){n.next().addClass("d-none")}),n.attr("aria-expanded","false"),n.trigger(i.default.Event("collapsed.lte.expandableTable"))):"false"===r&&(n.next().removeClass("d-none"),t.slideDown(500),n.attr("aria-expanded","true"),n.trigger(i.default.Event("expanded.lte.expandableTable")))},n._jQueryInterface=function(t){return this.each(function(){var r=i.default(this).data("lte.expandableTable");r||(r=new n(i.default(this)),i.default(this).data("lte.expandableTable",r));"string"==typeof t&&t.match(/init|toggleRow/)&&r[t]()})},n}();i.default(".expandable-table").ready(function(){s._jQueryInterface.call(i.default(this),"init")});i.default(document).on("click",'[data-widget="expandable-table"]',function(){s._jQueryInterface.call(i.default(this),"toggleRow")});i.default.fn[k]=s._jQueryInterface;i.default.fn[k].Constructor=s;i.default.fn[k].noConflict=function(){return i.default.fn[k]=ii,s._jQueryInterface};var d="Fullscreen",ri=i.default.fn[d],lt={minimizeIcon:"fa-compress-arrows-alt",maximizeIcon:"fa-expand-arrows-alt"},g=function(){function n(n,t){this.element=n;this.options=i.default.extend({},lt,t)}var t=n.prototype;return t.toggle=function(){document.fullscreenElement||document.mozFullScreenElement||document.webkitFullscreenElement||document.msFullscreenElement?this.windowed():this.fullscreen()},t.fullscreen=function(){document.documentElement.requestFullscreen?document.documentElement.requestFullscreen():document.documentElement.webkitRequestFullscreen?document.documentElement.webkitRequestFullscreen():document.documentElement.msRequestFullscreen&&document.documentElement.msRequestFullscreen();i.default('[data-widget="fullscreen"] i').removeClass(this.options.maximizeIcon).addClass(this.options.minimizeIcon)},t.windowed=function(){document.exitFullscreen?document.exitFullscreen():document.webkitExitFullscreen?document.webkitExitFullscreen():document.msExitFullscreen&&document.msExitFullscreen();i.default('[data-widget="fullscreen"] i').removeClass(this.options.minimizeIcon).addClass(this.options.maximizeIcon)},n._jQueryInterface=function(t){var r=i.default(this).data("lte.fullscreen"),f,u;r||(r=i.default(this).data());f=i.default.extend({},lt,"object"==typeof t?t:r);u=new n(i.default(this),f);i.default(this).data("lte.fullscreen","object"==typeof t?t:r);"string"==typeof t&&t.match(/toggle|fullscreen|windowed/)?u[t]():u.init()},n}();i.default(document).on("click",'[data-widget="fullscreen"]',function(){g._jQueryInterface.call(i.default(this),"toggle")});i.default.fn[d]=g._jQueryInterface;i.default.fn[d].Constructor=g;i.default.fn[d].noConflict=function(){return i.default.fn[d]=ri,g._jQueryInterface};var ui=i.default.fn.Layout,h=".main-sidebar .sidebar",fi={scrollbarTheme:"os-theme-light",scrollbarAutoHide:"l",panelAutoHeight:!0,loginRegisterAutoHeight:!0},nt=function(){function t(n,t){this._config=t;this._element=n;this._init()}var n=t.prototype;return n.fixLayoutHeight=function(n){var e,o,u;void 0===n&&(n=null);e=i.default("body");o=0;(e.hasClass("control-sidebar-slide-open")||e.hasClass("control-sidebar-open")||"control_sidebar"===n)&&(o=i.default(".control-sidebar-content").height());var t={window:i.default(window).height(),header:0!==i.default(".main-header").length?i.default(".main-header").outerHeight():0,footer:0!==i.default(".main-footer").length?i.default(".main-footer").outerHeight():0,sidebar:0!==i.default(h).length?i.default(h).height():0,controlSidebar:o},f=this._max(t),r=this._config.panelAutoHeight;!0===r&&(r=0);u=i.default(".content-wrapper");!1!==r&&(f===t.controlSidebar?u.css("min-height",f+r):f===t.window?u.css("min-height",f+r-t.header-t.footer):u.css("min-height",f+r-t.header),this._isFooterFixed()&&u.css("min-height",parseFloat(u.css("min-height"))+t.footer));e.hasClass("layout-fixed")&&(!1!==r&&u.css("min-height",f+r-t.header-t.footer),"undefined"!=typeof i.default.fn.overlayScrollbars&&i.default(h).overlayScrollbars({className:this._config.scrollbarTheme,sizeAutoCapable:!0,scrollbars:{autoHide:this._config.scrollbarAutoHide,clickScrolling:!0}}))},n.fixLoginRegisterHeight=function(){var n=i.default("body"),r=i.default(".login-box, .register-box"),t;0===r.length?(n.css("height","auto"),i.default("html").css("height","auto")):(t=r.height(),n.css("min-height")!==t&&n.css("min-height",t))},n._init=function(){var n=this;this.fixLayoutHeight();!0===this._config.loginRegisterAutoHeight?this.fixLoginRegisterHeight():this._config.loginRegisterAutoHeight===parseInt(this._config.loginRegisterAutoHeight,10)&&setInterval(this.fixLoginRegisterHeight,this._config.loginRegisterAutoHeight);i.default(h).on("collapsed.lte.treeview expanded.lte.treeview",function(){n.fixLayoutHeight()});i.default('[data-widget="pushmenu"]').on("collapsed.lte.pushmenu shown.lte.pushmenu",function(){n.fixLayoutHeight()});i.default('[data-widget="control-sidebar"]').on("collapsed.lte.controlsidebar",function(){n.fixLayoutHeight()}).on("expanded.lte.controlsidebar",function(){n.fixLayoutHeight("control_sidebar")});i.default(window).resize(function(){n.fixLayoutHeight()});setTimeout(function(){i.default("body.hold-transition").removeClass("hold-transition")},50)},n._max=function(n){var t=0;return Object.keys(n).forEach(function(i){n[i]>t&&(t=n[i])}),t},n._isFooterFixed=function(){return"fixed"===i.default(".main-footer").css("position")},t._jQueryInterface=function(n){return void 0===n&&(n=""),this.each(function(){var r=i.default(this).data("lte.layout"),u=i.default.extend({},fi,i.default(this).data());r||(r=new t(i.default(this),u),i.default(this).data("lte.layout",r));"init"===n||""===n?r._init():"fixLayoutHeight"!==n&&"fixLoginRegisterHeight"!==n||r[n]()})},t}();i.default(window).on("load",function(){nt._jQueryInterface.call(i.default("body"))});i.default(h+" a").on("focusin",function(){i.default(".main-sidebar").addClass("sidebar-focused")});i.default(h+" a").on("focusout",function(){i.default(".main-sidebar").removeClass("sidebar-focused")});i.default.fn.Layout=nt._jQueryInterface;i.default.fn.Layout.Constructor=nt;i.default.fn.Layout.noConflict=function(){return i.default.fn.Layout=ui,nt._jQueryInterface};var tt="PushMenu",ei=i.default.fn[tt],at={autoCollapseSize:992,enableRemember:!1,noTransitionAfterReload:!0},c=function(){function t(n,t){this._element=n;this._options=i.default.extend({},at,t);0===i.default("#sidebar-overlay").length&&this._addOverlay();this._init()}var n=t.prototype;return n.expand=function(){var n=i.default("body");this._options.autoCollapseSize&&i.default(window).width()<=this._options.autoCollapseSize&&n.addClass("sidebar-open");n.addClass("sidebar-is-opening").removeClass("sidebar-collapse sidebar-closed").delay(50).queue(function(){n.removeClass("sidebar-is-opening");i.default(this).dequeue()});this._options.enableRemember&&localStorage.setItem("remember.lte.pushmenu","sidebar-open");i.default(this._element).trigger(i.default.Event("shown.lte.pushmenu"))},n.collapse=function(){var n=i.default("body");this._options.autoCollapseSize&&i.default(window).width()<=this._options.autoCollapseSize&&n.removeClass("sidebar-open").addClass("sidebar-closed");n.addClass("sidebar-collapse");this._options.enableRemember&&localStorage.setItem("remember.lte.pushmenu","sidebar-collapse");i.default(this._element).trigger(i.default.Event("collapsed.lte.pushmenu"))},n.toggle=function(){i.default("body").hasClass("sidebar-collapse")?this.expand():this.collapse()},n.autoCollapse=function(n){if(void 0===n&&(n=!1),this._options.autoCollapseSize){var t=i.default("body");i.default(window).width()<=this._options.autoCollapseSize?t.hasClass("sidebar-open")||this.collapse():!0===n&&(t.hasClass("sidebar-open")?t.removeClass("sidebar-open"):t.hasClass("sidebar-closed")&&this.expand())}},n.remember=function(){if(this._options.enableRemember){var n=i.default("body");"sidebar-collapse"===localStorage.getItem("remember.lte.pushmenu")?this._options.noTransitionAfterReload?n.addClass("hold-transition").addClass("sidebar-collapse").delay(50).queue(function(){i.default(this).removeClass("hold-transition");i.default(this).dequeue()}):n.addClass("sidebar-collapse"):this._options.noTransitionAfterReload?n.addClass("hold-transition").removeClass("sidebar-collapse").delay(50).queue(function(){i.default(this).removeClass("hold-transition");i.default(this).dequeue()}):n.removeClass("sidebar-collapse")}},n._init=function(){var n=this;this.remember();this.autoCollapse();i.default(window).resize(function(){n.autoCollapse(!0)})},n._addOverlay=function(){var t=this,n=i.default("<div />",{id:"sidebar-overlay"});n.on("click",function(){t.collapse()});i.default(".wrapper").append(n)},t._jQueryInterface=function(n){return this.each(function(){var r=i.default(this).data("lte.pushmenu"),u=i.default.extend({},at,i.default(this).data());r||(r=new t(this,u),i.default(this).data("lte.pushmenu",r));"string"==typeof n&&n.match(/collapse|expand|toggle/)&&r[n]()})},t}();i.default(document).on("click",'[data-widget="pushmenu"]',function(n){n.preventDefault();var t=n.currentTarget;"pushmenu"!==i.default(t).data("widget")&&(t=i.default(t).closest('[data-widget="pushmenu"]'));c._jQueryInterface.call(i.default(t),"toggle")});i.default(window).on("load",function(){c._jQueryInterface.call(i.default('[data-widget="pushmenu"]'))});i.default.fn[tt]=c._jQueryInterface;i.default.fn[tt].Constructor=c;i.default.fn[tt].noConflict=function(){return i.default.fn[tt]=ei,c._jQueryInterface};var it="SidebarSearch",oi=i.default.fn[it],r='[data-widget="sidebar-search"]',st=r+" .form-control",vt={arrowSign:"->",minLength:3,maxResults:7,highlightName:!0,highlightPath:!1,highlightClass:"text-light",notFoundText:"No element found!"},yt=[],f=function(){function u(n,t){this.element=n;this.options=i.default.extend({},vt,t);this.items=[]}var n=u.prototype;return n.init=function(){var n=this;0!=i.default(r).length&&(0==i.default(r).next(".sidebar-search-results").length&&i.default(r).after(i.default("<div />",{"class":"sidebar-search-results"})),0==i.default(".sidebar-search-results").children(".list-group").length&&i.default(".sidebar-search-results").append(i.default("<div />",{"class":"list-group"})),this._addNotFound(),i.default(".main-sidebar .nav-sidebar").children().each(function(t,i){n._parseItem(i)}))},n.search=function(){var u=this,t=i.default(st).val().toLowerCase(),r,n;if(t.length<this.options.minLength)return i.default(".sidebar-search-results .list-group").empty(),this._addNotFound(),void this.close();r=yt.filter(function(n){return n.name.toLowerCase().includes(t)});n=i.default(r.slice(0,this.options.maxResults));i.default(".sidebar-search-results .list-group").empty();0===n.length?this._addNotFound():n.each(function(n,t){i.default(".sidebar-search-results .list-group").append(u._renderItem(t.name,t.link,t.path))});this.open()},n.open=function(){i.default(r).parent().addClass("sidebar-search-open");i.default('[data-widget="sidebar-search"] .btn i').removeClass("fa-search").addClass("fa-times")},n.close=function(){i.default(r).parent().removeClass("sidebar-search-open");i.default('[data-widget="sidebar-search"] .btn i').removeClass("fa-times").addClass("fa-search")},n.toggle=function(){i.default(r).parent().hasClass("sidebar-search-open")?this.close():this.open()},n._parseItem=function(n,t){var o=this,e;if(void 0===t&&(t=[]),!i.default(n).hasClass("nav-header")){var r={},u=i.default(n).clone().find("> .nav-link"),f=i.default(n).clone().find("> .nav-treeview"),s=u.attr("href"),h=u.find("p").children().remove().end().text();(r.name=this._trimText(h),r.link=s,r.path=t,0===f.length)?yt.push(r):(e=r.path.concat([r.name]),f.children().each(function(n,t){o._parseItem(t,e)}))}},n._trimText=function(n){return t.trim(n.replace(/(\r\n|\n|\r)/gm," "))},n._renderItem=function(n,t,r){var f=this,e,u;return(r=r.join(" "+this.options.arrowSign+" "),this.options.highlightName||this.options.highlightPath)&&(e=i.default(st).val().toLowerCase(),u=new RegExp(e,"gi"),this.options.highlightName&&(n=n.replace(u,function(n){return'<b class="'+f.options.highlightClass+'">'+n+"<\/b>"})),this.options.highlightPath&&(r=r.replace(u,function(n){return'<b class="'+f.options.highlightClass+'">'+n+"<\/b>"}))),'<a href="'+t+'" class="list-group-item">\n        <div class="search-title">\n          '+n+'\n        <\/div>\n        <div class="search-path">\n          '+r+"\n        <\/div>\n      <\/a>"},n._addNotFound=function(){i.default(".sidebar-search-results .list-group").append(this._renderItem(this.options.notFoundText,"#",[]))},u._jQueryInterface=function(n){var t=i.default(this).data("lte.sidebar-search"),f,r;t||(t=i.default(this).data());f=i.default.extend({},vt,"object"==typeof n?n:t);r=new u(i.default(this),f);i.default(this).data("lte.sidebar-search","object"==typeof n?n:t);"string"==typeof n&&n.match(/init|toggle|close|open|search/)?r[n]():r.init()},u}();i.default(document).on("click",'[data-widget="sidebar-search"] .btn',function(n){n.preventDefault();f._jQueryInterface.call(i.default(r),"toggle")});i.default(document).on("keyup",st,function(n){if(38==n.keyCode)return n.preventDefault(),void i.default(".sidebar-search-results .list-group").children().last().focus();if(40==n.keyCode)return n.preventDefault(),void i.default(".sidebar-search-results .list-group").children().first().focus();var t=0;clearTimeout(t);t=setTimeout(function(){f._jQueryInterface.call(i.default(r),"search")},100)});i.default(document).on("keydown",".sidebar-search-results .list-group",function(n){var t=i.default(":focus");38==n.keyCode&&(n.preventDefault(),t.is(":first-child")?t.siblings().last().focus():t.prev().focus());40==n.keyCode&&(n.preventDefault(),t.is(":last-child")?t.siblings().first().focus():t.next().focus())});i.default(window).on("load",function(){f._jQueryInterface.call(i.default(r),"init")});i.default.fn[it]=f._jQueryInterface;i.default.fn[it].Constructor=f;i.default.fn[it].noConflict=function(){return i.default.fn[it]=oi,f._jQueryInterface};var si=i.default.fn.Toasts,hi={position:"topRight",fixed:!0,autohide:!1,autoremove:!0,delay:1e3,fade:!0,icon:null,image:null,imageAlt:null,imageHeight:"25px",title:null,subtitle:null,close:!0,body:null,"class":null},ot=function(){function n(n,t){this._config=t;this._prepareContainer();i.default("body").trigger(i.default.Event("init.lte.toasts"))}var t=n.prototype;return t.create=function(){var n=i.default('<div class="toast" role="alert" aria-live="assertive" aria-atomic="true"/>'),t,r,u,f;n.data("autohide",this._config.autohide);n.data("animation",this._config.fade);this._config.class&&n.addClass(this._config.class);this._config.delay&&500!=this._config.delay&&n.data("delay",this._config.delay);t=i.default('<div class="toast-header">');null!=this._config.image&&(r=i.default("<img />").addClass("rounded mr-2").attr("src",this._config.image).attr("alt",this._config.imageAlt),null!=this._config.imageHeight&&r.height(this._config.imageHeight).width("auto"),t.append(r));(null!=this._config.icon&&t.append(i.default("<i />").addClass("mr-2").addClass(this._config.icon)),null!=this._config.title&&t.append(i.default("<strong />").addClass("mr-auto").html(this._config.title)),null!=this._config.subtitle&&t.append(i.default("<small />").html(this._config.subtitle)),1==this._config.close)&&(u=i.default('<button data-dismiss="toast" />').attr("type","button").addClass("ml-2 mb-1 close").attr("aria-label","Close").append('<span aria-hidden="true">&times;<\/span>'),null==this._config.title&&u.toggleClass("ml-2 ml-auto"),t.append(u));n.append(t);null!=this._config.body&&n.append(i.default('<div class="toast-body" />').html(this._config.body));i.default(this._getContainerId()).prepend(n);f=i.default("body");f.trigger(i.default.Event("created.lte.toasts"));n.toast("show");this._config.autoremove&&n.on("hidden.bs.toast",function(){i.default(this).delay(200).remove();f.trigger(i.default.Event("removed.lte.toasts"))})},t._getContainerId=function(){return"topRight"==this._config.position?"#toastsContainerTopRight":"topLeft"==this._config.position?"#toastsContainerTopLeft":"bottomRight"==this._config.position?"#toastsContainerBottomRight":"bottomLeft"==this._config.position?"#toastsContainerBottomLeft":void 0},t._prepareContainer=function(){if(0===i.default(this._getContainerId()).length){var n=i.default("<div />").attr("id",this._getContainerId().replace("#",""));"topRight"==this._config.position?n.addClass("toasts-top-right"):"topLeft"==this._config.position?n.addClass("toasts-top-left"):"bottomRight"==this._config.position?n.addClass("toasts-bottom-right"):"bottomLeft"==this._config.position&&n.addClass("toasts-bottom-left");i.default("body").append(n)}this._config.fixed?i.default(this._getContainerId()).addClass("fixed"):i.default(this._getContainerId()).removeClass("fixed")},n._jQueryInterface=function(t,r){return this.each(function(){var u=i.default.extend({},hi,r),f=new n(i.default(this),u);"create"===t&&f[t]()})},n}();i.default.fn.Toasts=ot._jQueryInterface;i.default.fn.Toasts.Constructor=ot;i.default.fn.Toasts.noConflict=function(){return i.default.fn.Toasts=si,ot._jQueryInterface};var rt="TodoList",ci=i.default.fn[rt],li={onCheck:function(n){return n},onUnCheck:function(n){return n}},ut=function(){function n(n,t){this._config=t;this._element=n;this._init()}var t=n.prototype;return t.toggle=function(n){n.parents("li").toggleClass("done");i.default(n).prop("checked")?this.check(n):this.unCheck(i.default(n))},t.check=function(n){this._config.onCheck.call(n)},t.unCheck=function(n){this._config.onUnCheck.call(n)},t._init=function(){var t=this,n=this._element;n.find("input:checkbox:checked").parents("li").toggleClass("done");n.on("change","input:checkbox",function(n){t.toggle(i.default(n.target))})},n._jQueryInterface=function(t){return this.each(function(){var r=i.default(this).data("lte.todolist"),u,f;r||(r=i.default(this).data());u=i.default.extend({},li,"object"==typeof t?t:r);f=new n(i.default(this),u);i.default(this).data("lte.todolist","object"==typeof t?t:r);"init"===t&&f[t]()})},n}();i.default(window).on("load",function(){ut._jQueryInterface.call(i.default('[data-widget="todo-list"]'))});i.default.fn[rt]=ut._jQueryInterface;i.default.fn[rt].Constructor=ut;i.default.fn[rt].noConflict=function(){return i.default.fn[rt]=ci,ut._jQueryInterface};var ft="Treeview",ai=i.default.fn[ft],vi={trigger:'[data-widget="treeview"] .nav-link',animationSpeed:300,accordion:!0,expandSidebar:!1,sidebarButtonSelector:'[data-widget="pushmenu"]'},et=function(){function t(n,t){this._config=t;this._element=n}var n=t.prototype;return n.init=function(){i.default(".nav-item.menu-open .nav-treeview").css("display","block");this._setupListeners()},n.expand=function(n,t){var f=this,e=i.default.Event("expanded.lte.treeview"),r,u;this._config.accordion&&(r=t.siblings(".menu-open").first(),u=r.find(".nav-treeview").first(),this.collapse(u,r));t.addClass("menu-is-opening");n.stop().slideDown(this._config.animationSpeed,function(){t.addClass("menu-open");i.default(f._element).trigger(e)});this._config.expandSidebar&&this._expandSidebar()},n.collapse=function(n,t){var r=this,u=i.default.Event("collapsed.lte.treeview");t.removeClass("menu-is-opening menu-open");n.stop().slideUp(this._config.animationSpeed,function(){i.default(r._element).trigger(u);n.find(".menu-open > .nav-treeview").slideUp();n.find(".menu-open").removeClass("menu-open")})},n.toggle=function(n){var f=i.default(n.currentTarget),u=f.parent(),t=u.find("> .nav-treeview"),r;(t.is(".nav-treeview")||(u.is(".nav-item")||(t=u.parent().find("> .nav-treeview")),t.is(".nav-treeview")))&&(n.preventDefault(),r=f.parents(".nav-item").first(),r.hasClass("menu-open")?this.collapse(i.default(t),r):this.expand(i.default(t),r))},n._setupListeners=function(){var n=this,t=void 0!==this._element.attr("id")?"#"+this._element.attr("id"):"";i.default(document).on("click",""+t+this._config.trigger,function(t){n.toggle(t)})},n._expandSidebar=function(){i.default("body").hasClass("sidebar-collapse")&&i.default(this._config.sidebarButtonSelector).PushMenu("expand")},t._jQueryInterface=function(n){return this.each(function(){var r=i.default(this).data("lte.treeview"),u=i.default.extend({},vi,i.default(this).data());r||(r=new t(i.default(this),u),i.default(this).data("lte.treeview",r));"init"===n&&r[n]()})},t}();i.default(window).on("load.lte.treeview",function(){i.default('[data-widget="treeview"]').each(function(){et._jQueryInterface.call(i.default(this),"init")})});i.default.fn[ft]=et._jQueryInterface;i.default.fn[ft].Constructor=et;i.default.fn[ft].noConflict=function(){return i.default.fn[ft]=ai,et._jQueryInterface};n.CardRefresh=e;n.CardWidget=u;n.ControlSidebar=y;n.DirectChat=w;n.Dropdown=o;n.ExpandableTable=s;n.Fullscreen=g;n.Layout=nt;n.PushMenu=c;n.SidebarSearch=f;n.Toasts=ot;n.TodoList=ut;n.Treeview=et;Object.defineProperty(n,"__esModule",{value:!0})});
/*!
