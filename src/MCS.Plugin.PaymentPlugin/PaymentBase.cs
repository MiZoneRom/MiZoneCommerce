...
namespace MCS.Plugin.PaymentPlugin
{
    public class PaymentBase<T> where T : ConfigBase, new()
    {
        ...
        /// <returns></returns>
        public virtual PaymentInfo ProcessRefundReturn(HttpRequest context)
        {
            throw new PluginException("未实现此方法");
        }
        ...
        /// <exception cref="ApplicationException"></exception>
        /// <returns></returns>
        public virtual PaymentInfo ProcessRefundNotify(HttpRequest context)
        {
            throw new PluginException("未实现此方法");
        }
        ...
        /// <param name="para"></param>
        /// <returns></returns>
        public virtual EnterprisePayNotifyInfo ProcessEnterprisePayNotify(HttpRequest request)
        {
            throw new PluginException("未实现此方法");
        }
    }
