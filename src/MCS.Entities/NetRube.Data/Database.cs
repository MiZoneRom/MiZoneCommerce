    ...
    public class Database : IDisposable
    {
        ...
        public Database(string connectionStringName)
        {
            ...
            if (connectionStringName == "")
                connectionStringName = ConfigurationManager.ConnectionStrings("SqlServer").Name;
        ...
        public virtual void OnExecutedCommand(IDbCommand cmd)
        {
            ...
            if (time.TotalMilliseconds > 3000)
                MCS.Core.Log.Info(string.Format("超时SQL:{0}毫秒,{1}", time.TotalMilliseconds, LastCommand));
        }
        ...
        public void WriteLog()
        {
            try
            {
                MCS.Core.Log.Debug("时间: {0}\t数据库类型:{1}{2}{3}{2}{2}"
